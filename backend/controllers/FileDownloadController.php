...
use backend\models\search\FileDownloadSeach;
...
class FileDownloadController extends Controller
{
    ...
    public function actionIndexFileDownload() {
        $this->layout = 'main-frontend';
        $searchModel = new FileDownloadSeach();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('index-file-download', [
                    'searchModel' => $searchModel,
                    'dataProvider' => $dataProvider,
        ]);
    }
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->save()) {
                Yii::$app->session->setFlash('success', "File Download Berhasil Di Update");
                return $this->redirect(['index']);
            } else {
                Yii::$app->session->setFlash('danger', "File Download Gagal Di Update");
                return $this->redirect(['index']);
            }
        }
