...
/**
 * This is the model class for table "{{%master_jenis_berita}}".
 *
 * @property int $id
 ...
 */
class MasterJenisBerita extends \yii\db\ActiveRecord
 {
    ...
    {
        return $this->hasMany(Berita::className(), ['id_jenis_berita' => 'id']);
    }
}
