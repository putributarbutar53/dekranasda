...
/**
 * This is the model class for table "{{%master_kategori_produk}}".
 *
 * @property int $id
 ...
 */
class MasterKategoriProduk extends \yii\db\ActiveRecord
 {
    ...
    {
        return $this->hasMany(Produk::className(), ['id_kategori' => 'id']);
    }
}
