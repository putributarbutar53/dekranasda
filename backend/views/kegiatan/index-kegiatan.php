...
$kegiatan = \backend\models\Kegiatan::find()
        ->where(['active' => 10])
        ->all();
                        ...
                        <div class="col-lg-12 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                            <div class="search-info m-b50">
                                <div class="d-flex m-b10">
                                    <h2 class="search-result">Kegiatan/Event</h2>
                                </div>
                                <p class="found-posts m-b0">Ditemukan <?= count($kegiatan) . ' Kegiatan' ?></p>
                            </div>
                        </div>
                        <?php
                        foreach ($kegiatan as $kegiatans) {
                            ...
                            <div class="blog-card blog-grid">
                                <div class="dlab-post-media">
                                    <img src="' . Yii::getAlias('@web') . '/' . $kegiatans->foto . '" alt="" style="height:240px;"/>
                                </div>
                                <div class="blog-card-info">
                                    <div class="dlab-post-meta">
                                        <ul>                                            
                                            <li class="post-date">at <span>' . date("d M Y", strtotime($kegiatans->created_at)) . '</span></li>
                                        </ul>
                                    </div>
                                    <h4 class="title"><a href="' . Url::toRoute(['kegiatan/view-kegiatan', 'id' => $kegiatans->id]) . '">' . $kegiatans->judul . '</a></h4>
                                    <div class="dlab-feed-meta">
                                        <ul>                                            
                                            <li class="post-view"><a href="javascript:void(0);"><i class="fa fa-eye"></i><span>' . $kegiatans->jumlah_view . '</span></a></li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="side-bar sticky-top">                        
                        <div class="widget recent-posts-entry wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.8s">
                            <h6 class="widget-title"><span>Kegiatan/Event Populer</span></h6>
