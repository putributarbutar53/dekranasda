                        ...
                        <div class="col-lg-12 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                            <div class="search-info m-b50">
                                <div class="d-flex m-b10">
                                    <h2 class="search-result">Galeri Foto</h2>
                                </div>
                                <p class="found-posts m-b0">Ditemukan <?= count($galeri) . ' Galeri Foto' ?></p>
                            </div>
                        </div>
                        <?php
                        foreach ($galeri as $galeris) {
                            ...
                            <div class="blog-card blog-grid">
                                <div class="dlab-post-media">
                                    <img src="' . Yii::getAlias('@web') . '/' . $galeris->foto_thumbnail . '" alt="" style="height:250px;/>
                                </div>
                                <div class="blog-card-info">
                                    <div class="dlab-post-meta">
                                        <ul>
                                            <li class="post-date">at <span>' . date("d M Y", strtotime($galeris->created_at)) . '</span></li>
                                        </ul>
                                    </div>
                                    <h4 class="title"><a href="' . Url::toRoute(['galeri/view-galeri', 'id' => $galeris->id]) . '">' . $galeris->nama . '</a></h4>
                                    <div class="dlab-feed-meta">
                                        <ul>
                                            <li class="post-view"><a href="javascript:void(0);"><i class="fa fa-eye"></i><span>' . $galeris->jumlah_view . '</span></a></li>
